...
public class WorldCivCommand implements CommandExecutor {
    ...
    public static void addLightTutorial(Player player) {
        ...
        String introduction = worldciv + ChatColor.GRAY + " Welcome! You have entered the light tutorial.";
        String optout = ChatColor.GRAY + " If you ever want to leave the tutorial: " + ChatColor.YELLOW + "/wc quit" +ChatColor.GRAY + ".";
        String droptorch = ChatColor.GRAY + " We aren't sure if you have a torch with you, so for now, we will drop one in the center.";
        String cantfindit = ChatColor.GRAY + " If you moved out of the center, good luck finding it!";
        ...
        String justincasestealing = ChatColor.GRAY + " Just in case, we won't let you steal. We made it steal-proof.";
        ...
        String playersholdinglight = ChatColor.GRAY + " If there are other players nearby holding a torch, you are also illuminated. This will be crucial for dungeons!";
        ...
        String lightingen = ChatColor.GRAY + " With that said: the sun, lava, glowstone, and anything that provides light will provide you with vision.";
        ...
        String thx = ChatColor.GRAY + " If you have any other questions or comments, feel free to ask staff!";
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if(x == 2){
                    ...
                    Bukkit.getWorld("world").dropItemNaturally(location, is);
    ...
    public static void removeLightTutorial(Player player){
        ...
        if(!AnvilCreate.isAllFull(player, is)){
            player.sendMessage(ChatColor.GRAY + "Oh, that's right! We're taking back our torch!");
